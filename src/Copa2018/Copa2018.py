...
class CopaDoMundo2018(BaseDAO):        
    ...
    def get_csv_values(self) -> list[tuple]:
        '''
            ...
            :return: list[tuple]
        '''
        with open (r'src/Copa2018/DadosCSV/Dados_Copa2018.csv','r', encoding = 'utf-8') as file:
            data = []
...
instancia = CopaDoMundo2018()
dados = instancia.get_csv_values()
instancia.insert_values(dados)